        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="{{ url('/pages/about-us') }}" class="text-sm text-gray-400 hover:text-primary-400 transition-colors">About Us</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <span class="text-sm text-gray-400">support@pickkart.co.in</span>
                        </li>
                        <li class="flex items-center gap-3">
