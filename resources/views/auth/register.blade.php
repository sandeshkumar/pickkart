...
@section('title', 'Register - PickKart')
...
<div class="flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl font-heading font-extrabold text-gray-900 tracking-tight">Create an account</h1>
            <p class="mt-2 text-sm text-gray-500">Join PickKart and start shopping today</p>
        </div>
